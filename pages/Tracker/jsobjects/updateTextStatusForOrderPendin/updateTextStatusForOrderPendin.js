    ...
    {
      {
        (async () => {
          ...
          try {
            ...
            const updatedData = ordersPending.tableData.map(row => {
              if (row.id === id) {
            ...
            ordersPending.setData(updatedData);  // `table1` is the name of your table widget
