    ...
    {
      {
        (async () => {
          ...
          try {
            ...
            const updatedData = ordersOngoing.tableData.map(row => {
              if (row.id === id) {
            ...
            ordersOngoing.setData(updatedData);  // `table1` is the name of your table widget
